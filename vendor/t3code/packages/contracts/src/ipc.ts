...
export interface LocalApi {
  ...
  codexProfiles: {
    getState: () => Promise<CodexProfileState>;
    addProfile: (input: CodexProfileAddInput) => Promise<CodexProfileState>;
    removeProfile: (input: CodexProfileRemoveInput) => Promise<CodexProfileState>;
    switchProfile: (input: CodexProfileSwitchInput) => Promise<CodexProfileState>;
    reauthProfile: (input: CodexProfileReauthInput) => Promise<CodexProfileReauthResult>;
  };
}
