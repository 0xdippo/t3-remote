...
import { CodexProfilesService } from "./provider/CodexProfilesService";
...
const WsRpcLayer = WsRpcGroup.toLayer(
  Effect.gen(function* () {
    ...
    const codexProfiles = yield* CodexProfilesService;
    ...
    return WsRpcGroup.of({
      ...
      [WS_METHODS.codexProfilesGetState]: (_input) =>
        observeRpcEffect(
          WS_METHODS.codexProfilesGetState,
          codexProfiles.getState(),
          { "rpc.aggregate": "server" },
        ),
      [WS_METHODS.codexProfilesAdd]: (input) =>
        observeRpcEffect(
          WS_METHODS.codexProfilesAdd,
          codexProfiles.addProfile(input),
          { "rpc.aggregate": "server" },
        ),
      [WS_METHODS.codexProfilesRemove]: (input) =>
        observeRpcEffect(
          WS_METHODS.codexProfilesRemove,
          codexProfiles.removeProfile(input),
          { "rpc.aggregate": "server" },
        ),
      [WS_METHODS.codexProfilesSwitch]: (input) =>
        observeRpcEffect(
          WS_METHODS.codexProfilesSwitch,
          codexProfiles.switchProfile(input),
          { "rpc.aggregate": "server" },
        ),
      [WS_METHODS.codexProfilesReauth]: (input) =>
        observeRpcEffect(
          WS_METHODS.codexProfilesReauth,
          codexProfiles.reauthProfile(input),
          { "rpc.aggregate": "server" },
        ),
