...
describe("extractTerminalLinks", () => {
  ...
  it("finds Windows absolute paths with forward slashes", () => {
    const line = "see C:/workspace/project/src/file.ts:42 for details";
    const path = "C:/workspace/project/src/file.ts:42";
...
describe("resolvePathLinkTarget", () => {
  it("resolves relative paths against cwd", () => {
    ...
    ).toBe("/workspace/project/src/components/ThreadTerminalDrawer.tsx:42:7");
  });

  it("keeps absolute paths unchanged", () => {
    expect(
      resolvePathLinkTarget("/workspace/project/src/main.ts:12", "/workspace/project"),
    ).toBe("/workspace/project/src/main.ts:12");
  });

  it("keeps Windows absolute paths with forward slashes unchanged", () => {
    expect(
      resolvePathLinkTarget("C:/workspace/project/src/main.ts:12", "C:\\workspace\\project"),
    ).toBe("C:/workspace/project/src/main.ts:12");
  });
});
