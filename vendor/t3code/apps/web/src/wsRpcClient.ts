...
export interface WsRpcClient {
  ...
  readonly codexProfiles: {
    readonly getState: RpcUnaryNoArgMethod<typeof WS_METHODS.codexProfilesGetState>;
    readonly addProfile: RpcUnaryMethod<typeof WS_METHODS.codexProfilesAdd>;
    readonly removeProfile: RpcUnaryMethod<typeof WS_METHODS.codexProfilesRemove>;
    readonly switchProfile: RpcUnaryMethod<typeof WS_METHODS.codexProfilesSwitch>;
    readonly reauthProfile: RpcUnaryMethod<typeof WS_METHODS.codexProfilesReauth>;
  };
...
export function createWsRpcClient(
  ...
  return {
    ...
    codexProfiles: {
      getState: () =>
        transport.request((client) => client[WS_METHODS.codexProfilesGetState]({})),
      addProfile: (input) =>
        transport.request((client) => client[WS_METHODS.codexProfilesAdd](input)),
      removeProfile: (input) =>
        transport.request((client) => client[WS_METHODS.codexProfilesRemove](input)),
      switchProfile: (input) =>
        transport.request((client) => client[WS_METHODS.codexProfilesSwitch](input)),
      reauthProfile: (input) =>
        transport.request((client) => client[WS_METHODS.codexProfilesReauth](input)),
    },
    orchestration: {
      getSnapshot: () =>
