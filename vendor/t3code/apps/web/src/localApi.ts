...
export function createLocalApi(
  ...
  return {
    ...
    codexProfiles: {
      getState: rpcClient.codexProfiles.getState,
      addProfile: rpcClient.codexProfiles.addProfile,
      removeProfile: rpcClient.codexProfiles.removeProfile,
      switchProfile: rpcClient.codexProfiles.switchProfile,
      reauthProfile: rpcClient.codexProfiles.reauthProfile,
    },
  };
}
